...
* Version: 1.0                                                                                                                     *
* Purpose: To create an fifth extension for the storefront to test how they work                                                   *
************************************************************************************************************************************/

using Pageflex.Interfaces.Storefront;
using PageflexServices;

namespace MyFifthExtension
{

    public class ExtensionFive : SXIExtension
    {
        ...
        public override string UniqueName
        {
            get
            {
                return "ExtensionFive.FixTax.ByZipcode.website.com";
            }
        }
